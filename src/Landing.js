...
const Landing = () =>  (
    ...
    <header className="main_header_area">  
        <nav className="navbar navbar-expand-lg"> 
            <div className="navbar-brand">
				<Link
					className="logo" to="index.html"><img src={require("./images/pplogo.png")} width="160" alt=""/>
				</Link>
            </div>
            
            <button className="navbar-toggler" type="button" data-toggle="collapse" data-target=".navbar_supported"  aria-label="Toggle navigation"> 
    ...
    <section className="banner_area">  
    	...
    	<div className="illustration">  
			<img src={require("./images/laptop-try.png")} height="420" alt="" className="wow slideInRight img_1 animated"/>
			<img src={require("./images/phone-try3.png")} height="650" alt="" className="lfup img_2"/> 
      <img src={require("./images/icons-pls3.png")} height="320" alt="" className="wow slideInRight img_new"/>
    	</div> 
    ...
    <section className="experience_area">
    	<div className="container">
    		<div className="tittle">
    			<h4><i className="fa fa-clock"></i>Fast Setup</h4>
    		...
    		<div className="row">
    			...
    			<div className="col-lg-4 col-md-6">
    				<div className="experience">
						...
						<Link to="#" className="heading">Create an Account</Link>
    			...
    			<div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
    				<div className="experience">
						...
						<Link to="#" className="heading">Choose Your Template</Link>
    ...
    <footer className="footer_area">   
       <div className="container"> 
			<div className="footer_inner row">   
				<div className="col-lg-4 col-sm-6 footer_logo wow fadeIn"> 
					...
					<div className="language">
					 ...
					 <ul className="footer_social" style={{paddingTop: 30}}> 
						...
						<li>
							<Link to="#"><i className="fa fa-twitter"></i>
							</Link>
						</li>
						<li>
							<Link to="#">
				...
				<div className="footer_widget col-lg-2 col-sm-6 wow fadeIn" data-wow-delay="0.2s">
					<h4>Core Link</h4>
					<ul className="footer_nav">   
						<li>
							<Link to="#">Explore</Link>
						</li>     
						<li><Link to="#">Example Templates</Link></li>     
						<li><Link to="blog.html">Log In</Link></li>     
					</ul>
				</div>  
				<div className="footer_widget fw_2 col-lg-3 col-sm-6 wow fadeIn" data-wow-delay="0.4s">
					<h4>Contact</h4>
          <p>insert something ehre</p>
				</div>    
				<div className="footer_widget fw_3 col-lg-3 col-sm-6 wow fadeIn" data-wow-delay="0.6s">
				...
				<div className="row"> 
					<div className="col-md-6  wow slideInRight">
						<ul className="mobile_icon">
							<li><Link to="#" className="theme_btn apple"><i className="fab fa-apple"></i>Apple</Link></li>
							<li><Link to="#" className="theme_btn"><i className="fab fa-google-play"></i>Google</Link> </li> 
						</ul>
					</div>   
